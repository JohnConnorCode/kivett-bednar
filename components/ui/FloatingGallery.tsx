    ...
    <div ref={containerRef} className="relative py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        {Array.from({length: 8}).map((_, i) => (
          <motion.div
            key={i}
            className="absolute w-32 h-32 rounded-full bg-amber-600/5"
            style={{
            ...
            return (
              ...
              >
                ...
                <div className="relative aspect-[3/4] rounded-2xl overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-amber-600/20 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10" />
                  ...
                  <div className="absolute inset-0 border-2 border-amber-600/20 group-hover:border-amber-600/40 transition-colors duration-500 rounded-2xl" />
