    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-[50vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-charcoal-900 via-midnight-500 to-charcoal-900">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-bone">
          ...
          <p className="text-xl md:text-2xl max-w-2xl mx-auto leading-relaxed text-midnight-600 font-light">
          ...
          <div className="max-w-6xl mx-auto">
            {products && products.length > 0 ? (
              ...
              <div className="text-center py-24">
                <div className="bg-gradient-to-br from-midnight-500 to-charcoal-900 rounded-2xl p-16 max-w-2xl mx-auto border-2 border-midnight-600/20">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Link
                      href="/contact"
                      className="px-8 py-4 rounded-lg bg-midnight-600 text-bone font-bold hover:bg-midnight-700 transition-all transform hover:scale-105"
                    >
                      Get Notified
                    </Link>
                    <Link
